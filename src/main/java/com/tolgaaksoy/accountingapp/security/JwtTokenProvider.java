...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(UserDetailsImpl userDetailsImpl) {
    ...
    public String createToken(String username, List<Role> roleList) {
        ...
        claims.put("auth", roleList.stream().map(s -> new SimpleGrantedAuthority(s.getAuthority())).collect(Collectors.toList()));
